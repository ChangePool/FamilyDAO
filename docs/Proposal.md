...
FamilyDAO supports income sharing, helping to facilitate informal borrowing from relatives and friends that may cover daily needs, housing, school fees or unexpected costs for example.
<!-- In much of Africa, extended family networks act as a bank, business partner and welfare state combined, where kinship obligations mean income is frequently shared to support relatives with daily needs, housing, or school fees. -->
